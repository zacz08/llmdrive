...
parser.add_argument(
    "--backbone-lr", type=float, default=0.0003, help="The learning rate for backbone"
)
parser.add_argument(
    "--with-backbone-lr",
    action="store_true",
...
parser.add_argument(
    "--data_dir", 
    metavar="DIR", 
    default='/home/zc/datasets/lmdrive/LMDrive',
...
parser.add_argument(
    "--model",
    default="memfuser_baseline_e1d3",
    type=str,
    metavar="MODEL",
...
parser.add_argument(
    "--weight-decay", type=float, default=0.05, help="weight decay (default: 0.0001)"
)
parser.add_argument(
    "--clip-grad",
    type=float,
...
parser.add_argument(
    "--lr", type=float, default=0.00075, metavar="LR", help="learning rate (default: 0.01)"
)
parser.add_argument(
    "--lr-noise",
    type=float,
...
parser.add_argument(
    "--smoothed_l1", default=True, action='store_true', help="L1 smooth"
)
parser.add_argument(
    "--train-interpolation",
    type=str,
